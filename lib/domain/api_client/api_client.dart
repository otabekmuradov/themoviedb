...
import 'package:themoviedb/entity/favorite_movies.dart';
...
class ApiClient {
  ...
  static const _apiKey = 'fc75de8c1964cc6a564cc8c025d42ae9';
  ...
  Future<FavoriteMovies> favoriteMovies(
      int accountId, String sessionId, String locale, int page) async {
    parser(dynamic json) {
      final jsonMap = json as Map<String, dynamic>;
      final response = FavoriteMovies.fromJson(jsonMap);
      return response;
    }
